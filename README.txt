...
Digitare il comando make da terminale: non è necessario fare operazioni di clean sui file esguiti, in quanto già incluse nel makefile.
Dopo make si dovrenno inserire i nomi dei file .txt con i dati di input seguendo ciò che verrà richiesto da terminale.
